...
<template>
    <div @focusin="opened=true" @focusout="opened=false" id="main" tabindex=0>
        <div @click="opened=!opened" style="height:100%;">
            <slot id="selector" name="main" :currentItem="currentItem">
                <grid-shortcut columns="1fr 25px" style="padding:5px; cursor:pointer; height:100%; box-sizing: border-box;">
                    ...
                    <div class="center">
                        <fa-icon style="font-size:12px; color:white; transform:translateY(2px);" icon="fa-solid fa-chevron-down"></fa-icon>
                    </div>
                </grid-shortcut>
            </slot>
        </div>
